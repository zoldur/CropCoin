...
## Wallet update to 1.1.0.3
Run the following commands as **root** to update **CropCoin** to version **1.1.0.3**
```
cd /tmp
...
wget -N https://github.com/zoldur/CropCoin/releases/download/v.1.1.0.3/cropcoind.gz
gunzip cropcoind.gz
chmod +x cropcoind
